            ...
            <div class="col-auto col-md-10 col-lg-6">
                <div class="card shadow-sm py-4 m-4">
                    <div class="card-body px-md-0">
                        ...
                        <a href="guard_change_password.php" class="navbar-brand d-flex align-items-center justify-content-center small text-center">
                        ...
                        <form method="POST" id="changePasswordForm">
                            <div class="row align-items-center justify-content-center">
                                ...
                                <div class="col-md-10 d-flex justify-content-between">
                                    <a href="guard_dashboard.php" role="button" type="button" class="btn btn-success btn-sm px-5 px-md-3">
                    ...
                    success: function(response) {
                        if (response.success) {
                            Swal.fire({
                                ...
                                window.location.href = 'guard_dashboard.php'; // redirect to dashboard
                            });
